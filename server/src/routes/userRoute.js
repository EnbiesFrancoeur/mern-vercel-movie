...
router.post(
  ...
  body("username")
    ...
    .custom(async (value) => {
      const userIsExist = await userModel.findOne({ username: value })
      if (userIsExist) return Promise.reject("username already exists")
    }),
  body("password")
    .exists()
  ...
  body("confirmPassword")
    ...
    .custom((value, { req }) => {
      if (value !== req.body.password)
        throw new Error("Your confirmation password doesn't match")
      return true
    }),
  body("displayName")
    .exists()
  ...
  body("confirmNewPassword")
    ...
    .custom((value, { req }) => {
      if (value !== req.body.newPassword)
        throw new Error("Your new confirmation password doesn't match")
      return true
    }),
  requestHandler.validate,
