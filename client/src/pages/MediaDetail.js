...
const MediaDetail = () => {
  ...
  const onFavoriteClick = async () => {
    ...
    if (response) {
      ...
      setIsFavorite(true)
      toast.success(`${body.mediaTitle} Added to your Favorites`)
    }
  }
  ...
  const onRemoveFavorite = async () => {
    ...
    if (response) {
      ...
      setIsFavorite(false)
      toast.success(`Remove ${favorite.mediaTitle} from your Favorites`)
    }
  }
      ...
      >
        ...
        <div ref={videoRef} style={{ paddingTop: "2rem" }}>
          <Container header="Videos">
            <MediaVideosSlide
              videos={[...media.videos.results].splice(0, 10)}
            />
          </Container>
        </div>
        {/* media videos */}
