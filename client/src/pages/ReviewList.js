    ...
    >
      <Box sx={{ width: { xs: "20%", md: "10%" } }}>
        <Link
          ...
          style={{ color: "unset", TextDecoder: "none" }}
        >
          <Box
            sx={{
              paddingTop: "160%",
      ...
      >
        <Stack spacing={1}>
          <Link
            to={routesGen.mediaDetail(review.mediaDetail, review.mediaId)}
          ...
          <Typography variant="caption">
            {dayjs(review.createdAt).format("llll")}
          </Typography>
...
const ReviewList = () => {
  ...
  const onRemoved = (id) => {
    ...
    toast.success(`Remove your review on ${removedReview.mediaTitle} `)
